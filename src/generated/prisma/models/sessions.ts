...
export type sessionsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"session_token" | "user_id" | "expires", ExtArgs["result"]["sessions"]>
...
export interface sessionsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `session_token`
   * const sessionsWithSession_tokenOnly = await prisma.sessions.findMany({ select: { session_token: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Sessions and only return the `session_token`
   * const sessionsWithSession_tokenOnly = await prisma.sessions.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Sessions and only return the `session_token`
   * const sessionsWithSession_tokenOnly = await prisma.sessions.updateManyAndReturn({
   *   select: { session_token: true },
   *   where: {
   *     // ... provide filter here
   *   },
